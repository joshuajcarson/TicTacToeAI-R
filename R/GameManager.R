...
play_multiple_rounds <- function(number_of_rounds = 100, X_AI = NA, O_AI = NA) {
  for(i in 1:100) {
    ...
    game_manager$game_history[game_manager$game_history == game_variables$UNKNOWN_WINNER] <<- determine_winner()
...
game_history_training <- game_manager$game_history[training_rows, 1:10]
game_history_testing <- game_manager$game_history[-training_rows, 1:10]
